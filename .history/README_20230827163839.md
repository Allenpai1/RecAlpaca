...
<div>
  ...
  <div style="float: right; width: calc(100% - 420px);">
    <img src="./imgs/inst.png" alt="Small Image 1" width="150px" style="margin-bottom: 10px;">
    <img src="./imgs/input.png" alt="Small Image 2" width="150px" style="margin-bottom: 10px;">
    <img src="./imgs/output.png" alt="Small Image 3" width="150px">
  </div>
</div>
